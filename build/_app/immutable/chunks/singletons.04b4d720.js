import { w as u } from "./index.4d678d2c.js";
import { a as g } from "./paths.d527816c.js";
const b = "1684397725350",
...
function T(e, t) {
  ...
  const l = e instanceof SVGAElement ? e.target.baseVal : e.target,
    s =
      !n ||
      !!l ||
      m(n, t) ||
...
function x(e) {
  ...
  for (; o && o !== document.documentElement; )
    l === null && (l = i(o, "preload-code")),
      s === null && (s = i(o, "preload-data")),
...
function v() {
  ...
  async function l() {
    clearTimeout(n);
    try {
      const s = await fetch(`${g}/_app/version.json`, {
        headers: { pragma: "no-cache", "cache-control": "no-cache" },
      });
      if (!s.ok) return !1;
      const a = (await s.json()).version !== b;
      return a && (e(!0), clearTimeout(n)), a;
    } catch {
      return !1;
    }
  }
  return { subscribe: t, check: l };
}
function m(e, t) {
...
const L = { url: p({}), page: p({}), navigating: u(null), updated: v() };
export {
  R as I,
  f as P,
  A as S,
