...
{#if spotlightArray.length > 0}
  <div class="hidden md:block w-full mx-auto" data-testid="hive-desktop">
    ...
    <div class="grid grid-cols-5 max-w-fit -mt-14 -space-x-2 mx-auto">
      <Cell
        type="section"
        link="about"
        backgroundImage="assets/meggyn-pomerleau-mGVtRqu-NUA-unsplash.jpg?url"
        testid="about-desktop"
      />
      <Cell type="empty" />
      <Cell
        type="section"
