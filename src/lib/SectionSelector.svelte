...
<button class="flex group gap-2 md:gap-0 p-2 md:min-w-80">
    ...
    <div class="text-2xl self-center md:text-4xl text-secondary-500 font-thin group-hover:font-medium transition-all ease-in-out delay-50 duration-200 motion-reduce:transition-none">{section}</div>
</button>