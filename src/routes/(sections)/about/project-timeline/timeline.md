...
<script>
    ...
    let timelineArray =  [{
        ...
        },
        {
            ...
            description: `In anticipation of the start of the project, the team interviews and hires the two Research Associates that will start working in September, [Balu](${base}/about/people/balu) and [Olivia](${base}/about/people/olivia)`
        },
        {
            date: "2022-09",
            dateString: "Sep 2022",
