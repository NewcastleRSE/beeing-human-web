---
title: "Thought experiment: a queen bee in interdisciplinary space"
id: connections-queen-bee
parent: connections
link: connections/queen-bee
lead: "We've been looking at how this book thinks with bees, and how the writing uses all these modes to move around the bees creating emotional insight. Its polyphony is a prompt and a challenge. The many elements of the book naturally worked together in Butler's mind, but in 2024 they are distributed between specialisms in the departments of the university. Revisiting Butler's book with a team representing the different strands of his thinking offers a unique chance to see how what we now call 'interdisciplinarity' works"
...
<ImgContainer imgUrl="/assets/articles/queen-bee/queenbee(1).jpg" altText="A close-up picture of a queen bumblebee in our lab" caption="A close up picture of a queen bumblebee in our lab"/>
...
We are bringing our expertise into dialogue most acutely in our annotation of [chapter 5](https://newcastlerse.github.io/beeing-human-web/literature/transcription#ch5), the central chapter of the book, where our glosses enrich Butler's text. This is innovative. You might usually find a chapter annotated by one scholar who was attempting to have an expansive and interdisciplinary approach, but here we are annotating this chapter as a group, talking to Butler closely side-by-side. 
...
[^1]: c.f. Terence Cave's [Thinking With Literature](https://global.oup.com/academic/product/thinking-with-literature-9780198749417).
