---
title: "Butler's ecology"
id: butlers-ecology
parent: literature
link: literature/butlers-ecology
lead: "Olivia explores the many references to plants and flowers in *The Feminine Monarchie* and how their use contributes to an *ecological* view of the world *avante la lettre*."
img: 'assets/articles/butlers-ecology/emma-henderson-B645igbiKCw-unsplash.jpg'
imgAlt: "a picture of a tree with a prominent root system"
type: article
layout: article
author: olivia
date: 2026/07/30
...
Like the bees themselves, Butler treats the flowers and plants around
him as living agents shaping the world of the bees and the beekeeper.
Flowers and plants move through multiple roles in *The Feminine
Monarchie*: medicinal, ecological, architectural, behavioural,
...
supplied a [list of plants that appear in *The Femmine Monarchie* with
their names and places]({base}/literature/plants-list).

## Chapter I

Butler begins his story of plants with the human body and the
beekeeper's unguarded vulnerability, introducing *flora* not through
...
Butler lists houseleek, rue, mallows, ivy, marigold, and hollyhock as
...
> Rue drunken with Wine, or rather with Hydromel, or the leaves stamped
> with Honie and Salt, and laid to the wound, is good against stinging
> of Bees, Waspes, Hornets, and Scorpions; Dodoens, l.2.c.83.[^1]

Even before Butler elaborates the hive's organisation or the bees'
...
into the relevant parts of his library and experience.

## Chapter II

> Beehives and bees are very greatly suited to gardens and flowers, a
> business of especial profit and economy, where circumstances have been
> favourable. *NH* XXI.70(41)

In Chapter II, plants define the physical environment in which bees live
and work. Trees and herbs are understood as architectural features
shaping air, shade, and bee behaviour.

Plum, cherry, apple, filbert, hazel, thorn are preferred for catching or
...
bees that fall among them.

These categories reveal an early modern understanding of plant
microclimates.[^2] Butler perceives how shade, height, and
...
dense foliage.[^3] Although bees can of course live unkept, they ideally
...
The procedural organisation of the beekeeping garden operates in
Pliny's cultural tradition of sensory awareness. The quotation at the
top of this section, which Butler attached to the
[reference-webbing](https://bee-inghuman.newcastle.ac.uk/literature/cross-references)
of his book, is from a text that is all about considerations of how the
...
attunes himself and his property to his bees.[^4] Attunement, in this
...
In Chapter III, plants are no longer merely part of the landscape; they
...
One such example is thyme, about which the [Folger library has made
this lovely
video](https://www.youtube.com/watch?v=OapyM4s3Qbg).

Natural material is used to craft beekeeping equipment. Wheat and rye
...
In the procedural sense, we are building a beehive; in the dramatic
sense, we are setting the stage, in a palace, or theatre, woven from
plant matter.

## Chapter V

Chapter V treats plants as practical instruments for predicting,
...
Butler repeatedly ties the movement of the swarm to seasonal flowering
...
dangerous and largely unprofitable.

Here Butler describes the idea that the weather makes flowers more
concentrated:

> \[I\]n hot and drie weather the hony dewes are raised, and the
...
> long without interruption. ([I2v]({base}/literature/transcription#ch5glon1))

Chapter V also attends to the sound of swarming. Butler repeatedly
...
between bee and human (in that one direction).

Aromatic herbs are shaken or brushed through the moving cloud of bees;
...
chapter extends a tradition already visible in Pliny's *Natural
History*, where bees are described as particularly responsive to
...
movement, settlement, and behaviour of the swarm itself.

## Chapter VI

Chapter VI is the botanical centrepiece of *The Feminine Monarchie*.
...
ecology formalised the concept.

'Phenology' now denotes the timing of natural events, and the way that
...
collaborative phenological calendar, [which you can see
here](https://naturescalendar.woodlandtrust.org.uk/). Some
consider Robert Marsham as the first phenologist, and his article
*Indications of Spring*, published in the Royal Society's journal
*Philosophical Transactions* as the first openly phenological text.[^5]
However, it is clear that Butler's seasonal bee observations from
Wootton, which rest on a culture of popular zodiacal almanacs, form an
important part of the history of this kind of phenological thinking.

Plants appear in the text as seasonal markers. Each month — Pisces,
...
contemporary herbal and agricultural calendars:

- **Pisces:** winter gillyflower, hazel catkins
- **Aries:** box, withy-palm, daffodil, lily, blackthorn
- **Taurus:** plum, gooseberry, cherry, pear, apple, crab, barberry,
vetch, maple
- **Gemini:** beans, archangel, fumitory, ribwort, honeysuckle
- **Cancer:** benet, mallows, thyme, knapweed, blackberry
- **Leo:** lavender, melon, thistle, redweed
- **Virgo**--**Scorpio:** dandelion, heath, ivy, archangel

The sequence constructs a tonally shifting landscape through which the
...
English landscape itself, its textures and colour schemes,[^6] following
the changing availability of blossom, nectar, and pollen from late
winter into autumn.

It isn't as though this was unfamiliar \-- quite the opposite. Herbals
...
We also find the idea of 'honey dew' which was, before modern
...
to land on the leaves of trees:[^7]

> But the greatest plentie of the purest Nectar commeth from above:
...
> Honie-dew, you may perceive by the Bees: for, as if they smelled it
> [v:]({base}/literature/transcription#ch6bibln35)
> by the sweetnesse of the Aire, they presently issue out of their
...
> other for haste. ([O4r-v]({base}/literature/transcription#ch6par35)).

Butler also ranks plants according to their value for bees and honey
...
called 'floral consistency' or 'floral fidelity').

At the same time, the sheer density of botanical naming produces an
...
describe bee behaviour but formally reproduces it.[^8] Into this natural
...
different authors layered up in a lattice of bibliographic annotations.

Plants in Chapter VI also function symbolically and cosmologically.
Honeydew gathered from oak leaves becomes a divine substance, *coelestia
dona* — heavenly gifts — linking bee labour with providential order.
...
all these meanings without active tension between them.

## Chapter VII

> At the beginning of Wheat-harvest, the state of flowers decaying,
> which is alwaies about Virgo, the maine robbing beginneth. ([*FM*, R1r]({base}/literature/transcription#ch7par37))

In Chapter VII we meet enemies, and especially enemy bees. We see the
...
the supply of nectar diminishes rapidly.

The landscape itself changes texture, and the expansive scene of summer
...
absence and decline rather than their abundance.

Butler uses the entropy of the season as a pressure or intensifier on
...
reminiscent of modern experiments on bee stress.[^9] The chapter
...
abundance *dissipates*. The sonic energy of high summer has dispersed,
the numinous intensity has faded, and so have the flowers.

Classical natural history frequently associated failed forage and poor
flowering seasons with disorder among bees. Virgil's *Georgics*
repeatedly associates environmental instability with agitation and
...
Likewise, Pliny's *Natural History* stresses that the quality and
productivity of honey depend upon seasonal regularity, favourable
weather, and access to flowering plants.

## Chapter VIII

When the bees' natural foraging fails, the beekeeper must artificially
nourish the hive with substitute foods: figs, raisins, apples, pears,
and sweet wort.[^10] Butler presents these substances as emergency
...
Butler would have read about artificial feeding in Aristotle, who
...
would have added to his own trial and error at the hive.[^11]

The foods Butler lists are also significant because they belong as much
...
against the inevitability of natural decay.[^12]

At the same time, these substitute foods mirror the bees' own practices
...
strategies.[^13] The floral abundance of earlier chapters is transformed
into stored sweetness capable of extending life beyond the natural
flowering season.[^14]

Plants in Chapter VIII are therefore no longer ecological partners
...
humans. They are recompensed before their honey is enjoyed.

## Chapter X

In Chapter X, the beekeeper harvests the fruit of this labour, and the
final outcome of the bees' earlier industry with the flowers in the
garden.

After killing or removing the bees, and taking the combs, what remains
...
Some recipes are unattributed, but are very similar to those found
...
remedy frequently overlap.[^15]

The unusual length of Chapter X reflects the preservative logic that
...
The final chapter restocks the beekeeper with copious resources
precisely at the moment when the flowering year has already passed. And
so it can all begin again.

\* \* \*

Following this line through the text, it is possible to see it as an
ecological text *avant la lettre* — one that interweaves botany,
...
the material kingdom upon which it rests.

[^1]: Rembert Dodoens, *Cruydeboeck* (Jan van der Loe, 1554). (=Dodoens,
    *A Nievve Herball, or Historie of Plants*, trans. Henry Lyte (Gerard
    Dewes, 1578).)

[^2]: Modern pollinator ecology increasingly emphasises the importance
    ...
    Pollinators' Colour Vision', *Journal of Comparative Physiology
    A*, 171.2 (1992): 171--181. Springer, doi:10.1007/BF00188925. And
    Thomas D. Seeley, *Honeybee Democracy* (Princeton University Press,
    2010).

[^3]: John Parkinson, *Theatrum Botanicum: The Theater of Plants*
    (Thomas Cotes, 1640).

[^4]: Eleni Hall Manolaraki, 'Senses and the Sacred in Pliny's
    *Natural History*'. *Illinois Classical Studies*, 43.1 (2018):
    207--33. *JSTOR*, https://doi.org/10.5406/illiclasstud.43.1.0207,
    p.214.
...
[^8]: See Ann Blair, *Too Much to Know: Managing Scholarly Information
    before the Modern Age* (Yale University Press, 2010) and Seneca,
    *Epistles* 84.3--5. Terence Cave, *The Cornucopian Text: Problems of
    Writing in the French Renaissance* (Oxford: Clarendon Press, 1979).

[^9]: See Vivek Nityananda's work for the Bee-ing Human project.
    https://www.ncl.ac.uk/cbe/staff/profile/viveknityananda.html

[^10]: Figs are actually inverted flowers.

[^11]: Aristotle, *Historia Animalium* IX.40

[^12]: Kristine Kowalchuk, *Preserving on Paper: Seventeenth-Century
    Englishwomen's Receipt Books* (University of Toronto Press, 2017).

[^13]: Artificial feeding is still a mainstream practice, for example
    see this 2025 government document from the National Bee Unit:
    https://www.nationalbeeunit.com/assets/PDFs/3_Resources_for_beekeepers/Best_practice_guidelines/BPG_7a_Feeding_Bees\_-\_sugar.pdf

[^14]: For a literary investigation of sweetness see Elizabeth Swann,
    *Taste and Knowledge in Early Modern England* (Cambridge University
    Press, 2020).

[^15]: Elaine Leong, *Recipes and Everyday Knowledge: Medicine, Science,
