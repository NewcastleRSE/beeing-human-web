...
<p>
  ...
  >. It uses the <a href="https://www.skeleton.dev">Skeleton</a> component library and <a href="https://www.npmjs.com/package/svelte-markdown?activeTab=readme">Svelte-Markdown</a> to render .md files into HTML.
</p>
